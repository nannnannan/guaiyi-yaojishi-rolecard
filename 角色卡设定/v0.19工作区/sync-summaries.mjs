...
write('摘要/衔接表.json',{previous_terminal:'E492',entry:'E493',blank_events:ledger.events.filter(e=>e.status==='blank').map(e=>e.id),pairs,terminal:'E540',future_event:null});
