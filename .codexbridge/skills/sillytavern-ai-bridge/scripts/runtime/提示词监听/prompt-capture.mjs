...
const DEFAULT_OUTPUT_ROOT = resolve(process.env.ST_OUTPUT_DIR || process.cwd(), 'st-bridge-output');
export const DEFAULT_CAPTURE_DIR = resolve(process.env.ST_CAPTURE_DIR || join(DEFAULT_OUTPUT_ROOT, 'captures'));
