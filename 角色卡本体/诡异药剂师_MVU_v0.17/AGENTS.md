# 《诡异药剂师》MVU v0.17 接手指南

更新：2026-09-13。本目录为当前维护工程 0.17.0，剧情止于 E434；先读根目录版本与工作区索引及本目录 README.md。
...
- 在 v0.16 基础上集成 v0.17 设定：新增 E397—E434 共 38 事件，S53—S59；总锚点 E01—E434。
- 全卡 434 事件、1179 世界书条目、28 名核心关系人物。
- 本轮概念：19 既有增量 + 37 新增 C1284—C1320（运行 UID 2573—2609）；事件素材 UID 1096—1133。
- 核心人物多阶段增量；新精简 NPC UID 307—315（无新增六组件）。
- E434 为开放终点；E400/E420/E434 含已授权 NSFW；E432 后身份失效隔离。
...
- 事件素材 UID700—1133 默认 disabled，UID1 负责事件全文注入。
...
- 本目录从 `诡异药剂师_MVU_v0.16` 复制建立，版本元数据为 `0.17.0`。
- **E397—E434 已集成；开放终点为 E434。**
- 集成来源：`../../角色卡设定/v0.17工作区`（精修交付说明.md）。
